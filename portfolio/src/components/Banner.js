    ...
    return (
        <Container fluid className="pt-5">
            <Row className="banner-row-1 d-flex align-items-center">
                ...
                <Col xs={12} md={6} className={`d-none d-md-block flex-column pl-md-5 text-left ${fadeInSkills ? 'is-visible' : 'is-visible'}`} ref={ref}>
                    <h1 className="display-1">Hi, I'm Rian!</h1>
                    <h2 className="display-4">Full-Stack Software Developer</h2>
                    <h4 className="lead pl-1">HTML, CSS, JavaScript, Python, Django, React.js, jQuery, Flask, SQL, MongoDB, AWS</h4>
                </Col>
                <Col md={6} className={`banner-img d-none d-md-block ${fadeInSkills ? 'is-visible' : 'is-visible'}`} ref={ref}></Col>
                <Col className={`learn-more-button text-center d-none d-md-block pb-4 ${fadeInSkills ? 'is-visible' : 'is-visible'}`} ref={ref}>
                ...
                <Col xs={12} md={6} className="d-md-none flex-column d-flex justify-content-center align-items-left pl-md-5 text-center">
                    ...
                    <h4 className="lead pl-1">HTML, CSS, JavaScript, Python, Django, React.js, Node.js, jQuery, Flask, SQL, MongoDB, AWS</h4>
